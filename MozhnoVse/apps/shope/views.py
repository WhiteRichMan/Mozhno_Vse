...
class SweetsViewSet(JsonResponseMixin, ViewSet):
    """ViewSet for Anime."""

    permission_classes: tuple = (
        SweetsPermission,
    )
    queryset: QuerySet[Sweets] = \
        Sweets.objects.get_not_deleted()
    ...
    def get_queryset(self) -> QuerySet[Sweets]:
    ...
    def list_2(self, request: DRF_Request) -> DRF_Response:
        """Handles GET-request to list Sweets."""
